...
% Last Modified by GUIDE v2.5 30-Oct-2018 22:23:16
...
% % Eliminar cualquier puerto abierto en MATLAB
% delete(instrfind({'Port'},{'COM3'}))
% %Crear un objeto serial
% handles.ser = serial('COM3', 'BaudRate',9600,'Terminator','LF',...
%     'Timeout',10);
...
global hax;                       %handles axes
global haled_1;                   %handles led 1
global haled_2;                   %handles led 2
global sample;
sample=150;  %plot scale
hax = handles.axes2;
%haled_1 = handles.led1_value;
%haled_2 = handles.led2_value;
xlabel('scale','FontSize',10,'Parent',hax); 
ylabel('Voltage(V)','FontSize',10,'Parent',hax); 
grid(hax,'on');


function SerialEvent(sObject, eventdata, hGui)
% get the updated handle /obtener el identificador actualizado
handles = guidata(hGui);
% get data from serial port /obtener datos del puerto serie
tmp_c = fscanf(sObject);
set(handles.edit9, 'String', tmp_c)
% Updates handle structure /Actualizaciones manejan estructura
...
% fclose(handles.ser);
% delete(handles.ser);
% % Hint: delete(hObject) closes the figure /cierra la figura
% delete(hObject);
...
% handles    empty - handles not created until after all CreateFcns called
imshow('Imagen.jpg');
text(50,40,'SEGUIDOR SOLAR','Fontname','Arial','Fontsize',25,'Fontangle','Italic', ...
